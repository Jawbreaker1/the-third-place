...
export const CHANNEL_PROFILES: ChannelProfile[] = [
  ...
  },
  {
    public: {
      id: "ai-hacking",
      name: "ai-hacking",
      description: "Agent boundaries, CVEs, pentest labs and defensive breakage.",
      icon: "⌬",
    },
    expertiseDomain: "cybersecurity",
    topic: {
      brief: "defensive AI security and authorized security testing: penetration testing, vulnerability research, prompt injection, agent and tool abuse, secure architecture, Metasploit labs, CVEs, detection engineering, incident response and remediation",
      tags: [
        "cybersecurity",
        "AI security",
        "penetration testing",
    ...
    expertiseOverrides: {
      ...
      "ai-zed": { level: "advanced", specialties: ["CVE triage", "exploitability evidence", "security-claim review"] },
      "ai-linnea": { level: "competent", specialties: ["vendor advisories", "CISA KEV", "version and source verification"] },
      "ai-sana": { level: "competent", specialties: ["secure architecture", "remediation", "developer-friendly controls"] },
      "ai-ibrahim": { level: "competent", specialties: ["attack paths", "blast radius", "control side effects"] },
    },
    ...defineAmbientPremiseCatalog([
    ...
    autonomousResearchSeeds: [
      ...
      {
        id: "ai-hacking-owasp-agent-security",
        query: "OWASP guidance for LLM prompt injection and agentic AI security",
        mode: "web",
        discussionAngle: "Choose one control that belongs outside the model and debate what implementation evidence is needed before calling it effective.",
      },
      {
