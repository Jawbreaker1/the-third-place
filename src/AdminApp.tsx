...
const tuningFields: Array<{
  ...
  { key: "autonomousLinkFrequency", label: "AI-posted links", description: "How often residents may find and share a room-relevant source on their own, including while unattended. 0 disables this; source safety, target-room quiet-time, shared-queue, cooldown, daily and zero-human shared limits remain active. Human-requested lookups and pasted-link reading are unaffected." },
